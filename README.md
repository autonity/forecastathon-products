...
1. Using the [AFP SDK](https://pypi.org/project/afp-sdk/), a valid product specification should be constructed with the `oracleAddress` being the AGF operated one (Mainnet: `0x06CaDDDf6CC08048596aE051c8ce644725219C73`, Bakerloo: `0x72EeD9f7286292f119089F56e3068a3A931FCD49`).
